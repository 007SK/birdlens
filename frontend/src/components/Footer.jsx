...
export default function Footer() {
  ...
  return (
    <footer className="app-footer">
      ...
      <div className="footer-branding" ref={containerRef}>
        {cardOpen && (
          <div className="footer-card">
            <img src={swatiPhoto} alt="Swati Kumari" className="footer-card__avatar" />
            <p className="footer-card__name">Swati Kumari</p>
            <p className="footer-card__title">Product Manager</p>
            <p className="footer-card__quote">
              "Since moving to the mountains, I kept hearing birds I couldn't name — so I built this."
            </p>
            <div className="footer-card__links">
              <a href="https://github.com/007SK" target="_blank" rel="noreferrer" className="footer-card__link">
              ...
              <a href="https://www.linkedin.com/in/007sk/" target="_blank" rel="noreferrer" className="footer-card__link">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
